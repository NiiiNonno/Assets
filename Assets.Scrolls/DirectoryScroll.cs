...
namespace Nonno.Assets.Scrolls
{
    ...
    public abstract class StreamSection : ISection, IDisposable
    {
        ...
        public bool IsEmpty => Length == _start;
        ...
        public StreamSection(long maxLength = long.MaxValue)
        {
            ...
            _ = stream.Read(buf);
            _next = BinaryConverter.ToInt64(buf);
            _stream = stream;
        ...
        public async Task<int> ReadAsync(Memory<byte> memory)
        {
        ...
        public async Task<int> WriteAsync(ReadOnlyMemory<byte> memory)
        {
            var rest = (int)(MaxLength - _stream!.Length);
        ...
        void Update()
        {
            ...
            BinaryConverter.ToBytes(_next, span);
            BinaryConverter.ToBytes(_start, span[64..]);
